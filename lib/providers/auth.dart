...
import 'package:worker/helpers/screen_navigation.dart';
import 'package:worker/helpers/user_service.dart';
import 'package:worker/models/user.dart';
...
//  getter
  ...
  Future<void> verifyPhoneNumber(BuildContext context, String number, String name) async {
